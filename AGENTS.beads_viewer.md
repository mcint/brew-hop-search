<!-- Copied verbatim from github.com/Dicklesworthstone/beads_viewer (main, 2026-06-05); local bv 0.16.4 via Homebrew. Project-specific Go rules apply to beads_viewer itself; the br/bv workflow sections are what we use here. -->
